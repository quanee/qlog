...
<fieldset>
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="168">
            <path d="M12 2c1.1 0 2 .9 2 2s-.9 2-2 2-2-.9-2-2 .9-2 2-2zm9 7h-6v13h-2v-6h-2v6H9V9H3V7h18v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="24">
            <circle cx="12" cy="4" r="2"/>
            <path d="M19 13v-2c-1.54.02-3.09-.75-4.07-1.83l-1.29-1.43c-.17-.19-.38-.34-.61-.45-.01 0-.01-.01-.02-.01H13c-.35-.2-.75-.3-1.19-.26C10.76 7.11 10 8.04 10 9.09V15c0 1.1.9 2 2 2h5v5h2v-5.5c0-1.1-.9-2-2-2h-3v-3.45c1.29 1.07 3.25 1.94 5 1.95zm-6.17 5c-.41 1.16-1.52 2-2.83 2-1.66 0-3-1.34-3-3 0-1.31.84-2.41 2-2.83V12.1a5 5 0 1 0 5.9 5.9h-2.07z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="24">
            <path d="M4 10v7h3v-7H4zm6 0v7h3v-7h-3zM2 22h19v-3H2v3zm14-12v7h3v-7h-3zm-4.5-9L2 6v2h19V6l-9.5-5z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="24">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="48">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="24">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="48">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="72">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="72">
            <path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-7 9h-2V5h2v6zm0 4h-2v-2h2v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="72">
            <path d="M19 12h-2v3h-3v2h5v-5zM7 9h3V7H5v5h2V9zm14-6H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16.01H3V4.99h18v14.02z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96">
            <path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v10zm4 0h-2v-4h2v4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="24">
            <path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm2 14H7v-2h7v2zm3-4H7v-2h10v2zm0-4H7V7h10v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="48">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="96">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="96">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="96">
            <path d="M19 3h-4.18C14.4 1.84 13.3 1 12 1c-1.3 0-2.4.84-2.82 2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 0c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm-2 14l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="96">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="96">
            <path d="M19.35 10.04A7.49 7.49 0 0 0 12 4C9.11 4 6.6 5.64 5.35 8.04A5.994 5.994 0 0 0 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96zM14 13v4h-4v-4H7l5-5 5 5h-3z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120">
            <path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="24">
            <path d="M17 3H7c-1.1 0-1.99.9-1.99 2L5 21l7-3 7 3V5c0-1.1-.9-2-2-2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="48">
            <path d="M17 3H7c-1.1 0-1.99.9-1.99 2L5 21l7-3 7 3V5c0-1.1-.9-2-2-2zm0 15l-5-2.18L7 18V5h10v13z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="72">
            <path d="M20 8h-2.81a5.985 5.985 0 0 0-1.82-1.96L17 4.41 15.59 3l-2.17 2.17C12.96 5.06 12.49 5 12 5c-.49 0-.96.06-1.41.17L8.41 3 7 4.41l1.62 1.63C7.88 6.55 7.26 7.22 6.81 8H4v2h2.09c-.05.33-.09.66-.09 1v1H4v2h2v1c0 .34.04.67.09 1H4v2h2.81c1.04 1.79 2.97 3 5.19 3s4.15-1.21 5.19-3H20v-2h-2.09c.05-.33.09-.66.09-1v-1h2v-2h-2v-1c0-.34-.04-.67-.09-1H20V8zm-6 8h-4v-2h4v2zm0-4h-4v-2h4v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="96">
            <path d="M22.7 19l-9.1-9.1c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.4-1.3L9 6 6 9 1.6 4.7C.4 7.1.9 10.1 2.9 12.1c1.9 1.9 4.6 2.4 6.9 1.5l9.1 9.1c.4.4 1 .4 1.4 0l2.3-2.3c.5-.4.5-1.1.1-1.4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="120">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="120">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="120">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="120">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="120">
            <path d="M12 7.77L18.39 18H5.61L12 7.77M12 4L2 20h20L12 4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="24">
            <path d="M13 12h7v1.5h-7zm0-2.5h7V11h-7zm0 5h7V16h-7zM21 4H3c-1.1 0-2 .9-2 2v13c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 15h-9V6h9v13z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="48">
            <path d="M18 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 4h5v8l-2.5-1.5L6 12V4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="72">
            <path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="96">
            <path d="M9.01 14H2v2h7.01v3L13 15l-3.99-4v3zm5.98-1v-3H22V8h-7.01V5L11 9l3.99 4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="120">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="144">
            <path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="144">
            <path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="144">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="144">
            <path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="144">
            <path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zm2.46-7.12l1.41-1.41L12 12.59l2.12-2.12 1.41 1.41L13.41 14l2.12 2.12-1.41 1.41L12 15.41l-2.12 2.12-1.41-1.41L10.59 14l-2.13-2.12zM15.5 4l-1-1h-5l-1 1H5v2h14V4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="144">
            <path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 16H8v-2h8v2zm0-4H8v-2h8v2zm-3-5V3.5L18.5 9H13z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="144">
            <path d="M20 13H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1v-6c0-.55-.45-1-1-1zM7 19c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM20 3H4c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h16c.55 0 1-.45 1-1V4c0-.55-.45-1-1-1zM7 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168">
            <path d="M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="24">
            <path d="M18 7l-1.41-1.41-6.34 6.34 1.41 1.41L18 7zm4.24-1.41L11.66 16.17 7.48 12l-1.41 1.41L11.66 19l12-12-1.42-1.41zM.41 13.41L6 19l1.41-1.41L1.83 12 .41 13.41z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="48">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="72">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="96">
            <path d="M5 17h14v2H5zm7-12L5.33 15h13.34z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="120">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="144">
            <path d="M17 12h-5v5h5v-5zM16 1v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19a2 2 0 0 0 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-1V1h-2zm3 18H5V8h14v11z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="168">
            <path d="M4 18v3h3v-3h10v3h3v-6H4zm15-8h3v3h-3zM2 10h3v3H2zm15 3H7V5c0-1.1.9-2 2-2h6c1.1 0 2 .9 2 2v8z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="168">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="168">
            <path d="M12 10.9c-.61 0-1.1.49-1.1 1.1s.49 1.1 1.1 1.1c.61 0 1.1-.49 1.1-1.1s-.49-1.1-1.1-1.1zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm2.19 12.19L6 18l3.81-8.19L18 6l-3.81 8.19z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="168">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="168">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="168">
            <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="168">
            <path d="M16.5 3c-1.74 0-3.41.81-4.5 2.09C10.91 3.81 9.24 3 7.5 3 4.42 3 2 5.42 2 8.5c0 3.78 3.4 6.86 8.55 11.54L12 21.35l1.45-1.32C18.6 15.36 22 12.28 22 8.5 22 5.42 19.58 3 16.5 3zm-4.4 15.55l-.1.1-.1-.1C7.14 14.24 4 11.39 4 8.5 4 6.5 5.5 5 7.5 5c1.54 0 3.04.99 3.57 2.36h1.87C13.46 5.99 14.96 5 16.5 5c2 0 3.5 1.5 3.5 3.5 0 2.89-3.14 5.74-7.9 10.05z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="168">
            <path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-7 12h-2v-2h2v2zm0-4h-2V6h2v4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="24">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="48">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="72">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="96">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="120">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="144">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="168">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="192">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="192">
            <path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="192">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="192">
            <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="192">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="192">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 17h-2v-2h2v2zm2.07-7.75l-.9.92C13.45 12.9 13 13.5 13 15h-2v-.5c0-1.1.45-2.1 1.17-2.83l1.24-1.26c.37-.36.59-.86.59-1.41 0-1.1-.9-2-2-2s-2 .9-2 2H8c0-2.21 1.79-4 4-4s4 1.79 4 4c0 .88-.36 1.68-.93 2.25z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="192">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="192">
            <path d="M14.59 8L12 10.59 9.41 8 8 9.41 10.59 12 8 14.59 9.41 16 12 13.41 14.59 16 16 14.59 13.41 12 16 9.41 14.59 8zM12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="192">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="24">
            <path d="M6 2v6h.01L6 8.01 10 12l-4 4 .01.01H6V22h12v-5.99h-.01L18 16l-4-4 4-3.99-.01-.01H18V2H6zm10 14.5V20H8v-3.5l4-4 4 4zm-4-5l-4-4V4h8v3.5l-4 4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="48">
            <path d="M6 2v6h.01L6 8.01 10 12l-4 4 .01.01H6V22h12v-5.99h-.01L18 16l-4-4 4-3.99-.01-.01H18V2H6z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="72">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="96">
            <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="120">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="144">
            <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-6h2v6zm0-8h-2V7h2v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="168">
            <path d="M11 17h2v-6h-2v6zm1-15C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zM11 9h2V7h-2v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="192">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="216">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="216">
            <path d="M17.63 5.84C17.27 5.33 16.67 5 16 5L5 5.01C3.9 5.01 3 5.9 3 7v10c0 1.1.9 1.99 2 1.99L16 19c.67 0 1.27-.33 1.63-.84L22 12l-4.37-6.16z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="216">
            <path d="M17.63 5.84C17.27 5.33 16.67 5 16 5L5 5.01C3.9 5.01 3 5.9 3 7v10c0 1.1.9 1.99 2 1.99L16 19c.67 0 1.27-.33 1.63-.84L22 12l-4.37-6.16zM16 17H5V7h11l3.55 5L16 17z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="216">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="216">
            <path d="M19 19H5V5h7V3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="216">
            <path d="M9 21c0 .55.45 1 1 1h4c.55 0 1-.45 1-1v-1H9v1zm3-19C8.14 2 5 5.14 5 9c0 2.38 1.19 4.47 3 5.74V17c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-2.26c1.81-1.27 3-3.36 3-5.74 0-3.86-3.14-7-7-7zm2.85 11.1l-.85.6V16h-4v-2.3l-.85-.6A4.997 4.997 0 0 1 7 9c0-2.76 2.24-5 5-5s5 2.24 5 5c0 1.63-.8 3.16-2.15 4.1z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="216">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="216">
            <path d="M3 17h18v-2H3v2zm0 3h18v-1H3v1zm0-7h18v-3H3v3zm0-9v4h18V4H3z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="216">
            <path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm0-8h2V7H3v2zm4 4h14v-2H7v2zm0 4h14v-2H7v2zM7 7v2h14V7H7z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="216">
            <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240">
            <path d="M12 17c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm6-9h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6h1.9c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm0 12H6V10h12v10z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="24">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="48">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="72">
            <path d="M20 6H10v6H8V4h6V0H6v6H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="96">
            <path d="M19.44 9.03L15.41 5H11v2h3.59l2 2H5c-2.8 0-5 2.2-5 5s2.2 5 5 5c2.46 0 4.45-1.69 4.9-4h1.65l2.77-2.77c-.21.54-.32 1.14-.32 1.77 0 2.8 2.2 5 5 5s5-2.2 5-5c0-2.65-1.97-4.77-4.56-4.97zM7.82 15C7.4 16.15 6.28 17 5 17c-1.63 0-3-1.37-3-3s1.37-3 3-3c1.28 0 2.4.85 2.82 2H5v2h2.82zM19 17c-1.66 0-3-1.34-3-3s1.34-3 3-3 3 1.34 3 3-1.34 3-3 3z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="120">
            <path d="M14 2H6c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm2 14h-3v3h-2v-3H8v-2h3v-3h2v3h3v2zm-3-7V3.5L18.5 9H13z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg viewBox="0 0 24 24" width="24" height="24" x="240" y="144">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="192">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="216">
            <path d="M19 19H5V5h7V3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14c1.1 0 2-.9 2-2v-7h-2v7zM14 3v2h3.59l-9.83 9.83 1.41 1.41L19 6.41V10h2V3h-7z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="240">
            <path d="M10 9h4V6h3l-5-5-5 5h3v3zm-1 1H6V7l-5 5 5 5v-3h3v-4zm14 2l-5-5v3h-3v4h3v3l5-5zm-9 3h-4v3H7l5 5 5-5h-3v-3z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="240">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="240">
            <path d="M23 5.5V20c0 2.2-1.8 4-4 4h-7.3c-1.08 0-2.1-.43-2.85-1.19L1 14.83s1.26-1.23 1.3-1.25c.22-.19.49-.29.79-.29.22 0 .42.06.6.16.04.01 4.31 2.46 4.31 2.46V4c0-.83.67-1.5 1.5-1.5S11 3.17 11 4v7h1V1.5c0-.83.67-1.5 1.5-1.5S15 .67 15 1.5V11h1V2.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5V11h1V5.5c0-.83.67-1.5 1.5-1.5s1.5.67 1.5 1.5z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="240">
            <path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="240">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="240">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="240">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="240">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="240">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="240">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="264" y="48">
            <path d="M19 7h-8v6h8V7zm2-4H3c-1.1 0-2 .9-2 2v14c0 1.1.9 1.98 2 1.98h18c1.1 0 2-.88 2-1.98V5c0-1.1-.9-2-2-2zm0 16.01H3V4.98h18v14.03z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="264" y="72">
            <path d="M19 11h-8v6h8v-6zm4 8V4.98C23 3.88 22.1 3 21 3H3c-1.1 0-2 .88-2 1.98V19c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2zm-2 .02H3V4.97h18v14.05z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="264" y="96">
            <path d="M11 5v5.59H7.5l4.5 4.5 4.5-4.5H13V5h-2zm-5 9c0 3.31 2.69 6 6 6s6-2.69 6-6h-2c0 2.21-1.79 4-4 4s-4-1.79-4-4H6z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="264" y="120">
            <path d="M19 4h-4L7.11 16.63 4.5 12 9 4H5L.5 12 5 20h4l7.89-12.63L19.5 12 15 20h4l4.5-8z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="264" y="144">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="264" y="168">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="264" y="192">
            <path d="M19 8H5c-1.66 0-3 1.34-3 3v6h4v4h12v-4h4v-6c0-1.66-1.34-3-3-3zm-3 11H8v-5h8v5zm3-7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm-1-9H6v4h12V3z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="264" y="216">
            <path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="264" y="240">
            <path d="M21 6h-2v9H6v2c0 .55.45 1 1 1h11l4 4V7c0-.55-.45-1-1-1zm-4 6V3c0-.55-.45-1-1-1H3c-.55 0-1 .45-1 1v14l4-4h10c.55 0 1-.45 1-1z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="264">
            <path d="M18 17H6v-2h12v2zm0-4H6v-2h12v2zm0-4H6V7h12v2zM3 22l1.5-1.5L6 22l1.5-1.5L9 22l1.5-1.5L12 22l1.5-1.5L15 22l1.5-1.5L18 22l1.5-1.5L21 22V2l-1.5 1.5L18 2l-1.5 1.5L15 2l-1.5 1.5L12 2l-1.5 1.5L9 2 7.5 3.5 6 2 4.5 3.5 3 2v20z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="264">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="264">
            <path d="M20 6h-2.18c.11-.31.18-.65.18-1a2.996 2.996 0 0 0-5.5-1.65l-.5.67-.5-.68A3.01 3.01 0 0 0 9 2C7.34 2 6 3.34 6 5c0 .35.07.69.18 1H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-5-2c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zM9 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1zm11 15H4v-2h16v2zm0-5H4V8h5.08L7 10.83 8.62 12 11 8.76l1-1.36 1 1.36L15.38 12 17 10.83 14.92 8H20v6z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="264">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="264">
            <path d="M3 15h18v-2H3v2zm0 4h18v-2H3v2zm0-8h18V9H3v2zm0-6v2h18V5H3z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="264">
            <path d="M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="264">
            <path d="M13 3a9 9 0 0 0-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42A8.954 8.954 0 0 0 13 21a9 9 0 0 0 0-18zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="264">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="264">
            <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5a2.5 2.5 0 0 1 0-5 2.5 2.5 0 0 1 0 5z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="264">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="264">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="264" y="264">
            <path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288">
            <path d="M15.5 14h-.79l-.28-.27A6.47 6.47 0 0 0 16 9.5 6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288" y="24">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288" y="48">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288" y="72">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288" y="96">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288" y="120">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288" y="144">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288" y="168">
            <path d="M7.77 6.76L6.23 5.48.82 12l5.41 6.52 1.54-1.28L3.42 12l4.35-5.24zM7 13h2v-2H7v2zm10-2h-2v2h2v-2zm-6 2h2v-2h-2v2zm6.77-7.52l-1.54 1.28L20.58 12l-4.35 5.24 1.54 1.28L23.18 12l-5.41-6.52z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288" y="192">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="288">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="288">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="288">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="288">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="288">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="288">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="288">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="288">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="288">
            <path d="M7 18c-1.1 0-1.99.9-1.99 2S5.9 22 7 22s2-.9 2-2-.9-2-2-2zM1 2v2h2l3.6 7.59-1.35 2.45c-.16.28-.25.61-.25.96 0 1.1.9 2 2 2h12v-2H7.42c-.14 0-.25-.11-.25-.25l.03-.12.9-1.63h7.45c.75 0 1.41-.41 1.75-1.03l3.58-6.49A1.003 1.003 0 0 0 20 4H5.21l-.94-2H1zm16 16c-1.1 0-1.99.9-1.99 2s.89 2 1.99 2 2-.9 2-2-.9-2-2-2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="288">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="264" y="288">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288" y="288">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312">
            <path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zm4.24 16L12 15.45 7.77 18l1.12-4.81-3.73-3.23 4.92-.42L12 5l1.92 4.53 4.92.42-3.73 3.23L16.23 18z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="24">
            <path d="M20 4H4v2h16V4zm1 10v-2l-1-5H4l-1 5v2h1v6h10v-6h4v6h2v-6h1zm-9 4H6v-4h6v4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="48">
            <path d="M14 17H4v2h10v-2zm6-8H4v2h16V9zM4 15h16v-2H4v2zM4 5v2h16V5H4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="72">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="96">
            <path d="M6.99 11L3 15l3.99 4v-3H14v-2H6.99v-3zM21 9l-3.99-4v3H10v2h7.01v3L21 9z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="120">
            <path d="M16 17.01V10h-2v7.01h-3L15 21l4-3.99h-3zM9 3L5 6.99h3V14h2V6.99h3L9 3z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="144">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="168">
            <path d="M12 16.5l4-4h-3v-9h-2v9H8l4 4zm9-13h-6v1.99h6v14.03H3V5.49h6V3.5H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2v-14c0-1.1-.9-2-2-2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="192">
            <path d="M21 3H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h10v4h8v10z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="216">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="240">
            <path d="M18 3v2h-2V3H8v2H6V3H4v18h2v-2h2v2h8v-2h2v2h2V3h-2zM8 17H6v-2h2v2zm0-4H6v-2h2v2zm0-4H6V7h2v2zm10 8h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2V7h2v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="264">
            <path d="M15 3H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.09.23-.14.47-.14.73v1.91l.01.01L1 14c0 1.1.9 2 2 2h6.31l-.95 4.57-.03.32c0 .41.17.79.44 1.06L9.83 23l6.59-6.59c.36-.36.58-.86.58-1.41V5c0-1.1-.9-2-2-2zm4 0v12h4V3h-4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="288">
            <path d="M1 21h4V9H1v12zm22-11c0-1.1-.9-2-2-2h-6.31l.95-4.57.03-.32c0-.41-.17-.79-.44-1.06L14.17 1 7.59 7.59C7.22 7.95 7 8.45 7 9v10c0 1.1.9 2 2 2h9c.83 0 1.54-.5 1.84-1.22l3.02-7.05c.09-.23.14-.47.14-.73v-1.91l-.01-.01L23 10z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="312">
            <path d="M12 6c0-.55-.45-1-1-1H5.82l.66-3.18.02-.23c0-.31-.13-.59-.33-.8L5.38 0 .44 4.94C.17 5.21 0 5.59 0 6v6.5c0 .83.67 1.5 1.5 1.5h6.75c.62 0 1.15-.38 1.38-.91l2.26-5.29c.07-.17.11-.36.11-.55V6zm10.5 4h-6.75c-.62 0-1.15.38-1.38.91l-2.26 5.29c-.07.17-.11.36-.11.55V18c0 .55.45 1 1 1h5.18l-.66 3.18-.02.24c0 .31.13.59.33.8l.79.78 4.94-4.94c.27-.27.44-.65.44-1.06v-6.5c0-.83-.67-1.5-1.5-1.5z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="312">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="312">
            <path d="M3 9h14V7H3v2zm0 4h14v-2H3v2zm0 4h14v-2H3v2zm16 0h2v-2h-2v2zm0-10v2h2V7h-2zm0 6h2v-2h-2v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="312">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="312">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="120" y="312">
            <path d="M9 11.24V7.5a2.5 2.5 0 0 1 5 0v3.74c1.21-.81 2-2.18 2-3.74C16 5.01 13.99 3 11.5 3S7 5.01 7 7.5c0 1.56.79 2.93 2 3.74zm9.84 4.63l-4.54-2.26c-.17-.07-.35-.11-.54-.11H13v-6c0-.83-.67-1.5-1.5-1.5S10 6.67 10 7.5v10.74l-3.43-.72c-.08-.01-.15-.03-.24-.03-.31 0-.59.13-.79.33l-.79.8 4.94 4.94c.27.27.65.44 1.06.44h6.79c.75 0 1.33-.55 1.44-1.28l.75-5.27c.01-.07.02-.14.02-.2 0-.62-.38-1.16-.91-1.38z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="144" y="312">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="312">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="192" y="312">
            <path d="M16 18l2.29-2.29-4.88-4.88-4 4L2 7.41 3.41 6l6 6 4-4 6.3 6.29L22 12v6z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="216" y="312">
            <path d="M22 12l-4-4v3H3v2h15v3z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="312">
            <path d="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="264" y="312">
            <path d="M17 3H7c-1.1 0-1.99.9-1.99 2L5 21l7-3 7 3V5c0-1.1-.9-2-2-2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288" y="312">
            <path d="M17 3H7c-1.1 0-1.99.9-1.99 2L5 21l7-3 7 3V5c0-1.1-.9-2-2-2zm0 15l-5-2.18L7 18V5h10v13z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="312" y="312">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336">
            <path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="24">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="48">
            <path d="M4 18h3V5H4v13zM18 5v13h3V5h-3zM8 18h9V5H8v13z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="72">
            <path d="M7 19h10V4H7v15zm-5-2h4V6H2v11zM18 6v11h4V6h-4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="96">
            <path d="M10 18h5V5h-5v13zm-6 0h5V5H4v13zM16 5v13h5V5h-5z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="120">
            <path d="M2 21h19v-3H2v3zM20 8H3c-.55 0-1 .45-1 1v6c0 .55.45 1 1 1h17c.55 0 1-.45 1-1V9c0-.55-.45-1-1-1zM2 3v3h19V3H2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="144">
            <path d="M4 15h16v-2H4v2zm0 4h16v-2H4v2zm0-8h16V9H4v2zm0-6v2h16V5H4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="168">
            <path d="M4 14h4v-4H4v4zm0 5h4v-4H4v4zM4 9h4V5H4v4zm5 5h12v-4H9v4zm0 5h12v-4H9v4zM9 5v4h12V5H9z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="192">
            <path d="M4 11h5V5H4v6zm0 7h5v-6H4v6zm6 0h5v-6h-5v6zm6 0h5v-6h-5v6zm-6-7h5V5h-5v6zm6-6v6h5V5h-5z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="216">
            <path d="M10 18h5v-6h-5v6zm-6 0h5V5H4v13zm12 0h5v-6h-5v6zM10 5v6h11V5H10z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="240">
            <path d="M4 18h17v-6H4v6zM4 5v6h17V5H4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="264">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="288">
            <path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="336" y="312">
            <path d="M12 7c2.76 0 5 2.24 5 5 0 .65-.13 1.26-.36 1.83l2.92 2.92c1.51-1.26 2.7-2.89 3.43-4.75-1.73-4.39-6-7.5-11-7.5-1.4 0-2.74.25-3.98.7l2.16 2.16C10.74 7.13 11.35 7 12 7zM2 4.27l2.28 2.28.46.46A11.804 11.804 0 0 0 1 12c1.73 4.39 6 7.5 11 7.5 1.55 0 3.03-.3 4.38-.84l.42.42L19.73 22 21 20.73 3.27 3 2 4.27zM7.53 9.8l1.55 1.55c-.05.21-.08.43-.08.65 0 1.66 1.34 3 3 3 .22 0 .44-.03.65-.08l1.55 1.55c-.67.33-1.41.53-2.2.53-2.76 0-5-2.24-5-5 0-.79.2-1.53.53-2.2zm4.31-.78l3.15 3.15.02-.16c0-1.66-1.34-3-3-3l-.17.01z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="336">
            <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm4.2 14.2L11 13V7h1.5v5.2l4.5 2.7-.8 1.3z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="24" y="336">
            <path d="M20 6h-4V4c0-1.11-.89-2-2-2h-4c-1.11 0-2 .89-2 2v2H4c-1.11 0-1.99.89-1.99 2L2 19c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V8c0-1.11-.89-2-2-2zm-6 0h-4V4h4v2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="48" y="336">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="72" y="336">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="96" y="336">
...
<fieldset>
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg baseProfile="tiny" width="24" height="24"
             viewBox="0 0 24 24"
             x="96">
...
<fieldset>
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="0">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="360">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="384">
            <path fill-opacity=".3"
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="408">
            <path fill-opacity=".3"
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="432">
            <path fill-opacity=".3"
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="456">
            <path d="M15.67 4H14V2h-4v2H8.33C7.6 4 7 4.6 7 5.33v15.33C7 21.4 7.6 22 8.33 22h7.33c.74 0 1.34-.6 1.34-1.33V5.33C17 4.6 16.4 4 15.67 4zM11 20v-5.5H9L13 7v5.5h2L11 20z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="480">
            <path d="M15.67 4H14V2h-4v2H8.33C7.6 4 7 4.6 7 5.33v15.33C7 21.4 7.6 22 8.33 22h7.33c.74 0 1.34-.6 1.34-1.33V5.33C17 4.6 16.4 4 15.67 4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="504">
            <path d="M15.67 4H14V2h-4v2H8.33C7.6 4 7 4.6 7 5.33v15.33C7 21.4 7.6 22 8.33 22h7.33c.74 0 1.34-.6 1.34-1.33V5.33C17 4.6 16.4 4 15.67 4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="528">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="552">
            <path d="M17.71 7.71L12 2h-1v7.59L6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 11 14.41V22h1l5.71-5.71-4.3-4.29 4.3-4.29zM13 5.83l1.88 1.88L13 9.59V5.83zm1.88 10.46L13 18.17v-3.76l1.88 1.88z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="576">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="600">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="624">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="648">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="672">
            <path d="M20 8.69V4h-4.69L12 .69 8.69 4H4v4.69L.69 12 4 15.31V20h4.69L12 23.31 15.31 20H20v-4.69L23.31 12 20 8.69zM12 18c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6-2.69 6-6 6zm0-10c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="696">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="720">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="744">
            <path d="M13 2.05v3.03c3.39.49 6 3.39 6 6.92 0 .9-.18 1.75-.48 2.54l2.6 1.53c.56-1.24.88-2.62.88-4.07 0-5.18-3.95-9.45-9-9.95zM12 19c-3.87 0-7-3.13-7-7 0-3.53 2.61-6.43 6-6.92V2.05c-5.06.5-9 4.76-9 9.95 0 5.52 4.47 10 9.99 10 3.31 0 6.24-1.61 8.06-4.09l-2.6-1.53C16.17 17.98 14.21 19 12 19z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="768">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="792">
            <path d="M4 6h18V4H4c-1.1 0-2 .9-2 2v11H0v3h14v-3H4V6zm19 2h-6c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h6c.55 0 1-.45 1-1V9c0-.55-.45-1-1-1zm-1 9h-4v-7h4v7z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="816">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="840">
            <path d="M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm8.94 3c-.46-4.17-3.77-7.48-7.94-7.94V1h-2v2.06C6.83 3.52 3.52 6.83 3.06 11H1v2h2.06c.46 4.17 3.77 7.48 7.94 7.94V23h2v-2.06c4.17-.46 7.48-3.77 7.94-7.94H23v-2h-2.06zM12 19c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="864">
            <path d="M20.94 11c-.46-4.17-3.77-7.48-7.94-7.94V1h-2v2.06C6.83 3.52 3.52 6.83 3.06 11H1v2h2.06c.46 4.17 3.77 7.48 7.94 7.94V23h2v-2.06c4.17-.46 7.48-3.77 7.94-7.94H23v-2h-2.06zM12 19c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="888">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="912">
            <path d="M20.94 11c-.46-4.17-3.77-7.48-7.94-7.94V1h-2v2.06c-1.13.12-2.19.46-3.16.97l1.5 1.5C10.16 5.19 11.06 5 12 5c3.87 0 7 3.13 7 7 0 .94-.19 1.84-.52 2.65l1.5 1.5c.5-.96.84-2.02.97-3.15H23v-2h-2.06zM3 4.27l2.04 2.04C3.97 7.62 3.25 9.23 3.06 11H1v2h2.06c.46 4.17 3.77 7.48 7.94 7.94V23h2v-2.06c1.77-.2 3.38-.91 4.69-1.98L19.73 21 21 19.73 4.27 3 3 4.27zm13.27 13.27C15.09 18.45 13.61 19 12 19c-3.87 0-7-3.13-7-7 0-1.61.55-3.09 1.46-4.27l9.81 9.81z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="936">
            <path d="M20.94 11c-.46-4.17-3.77-7.48-7.94-7.94V1h-2v2.06C6.83 3.52 3.52 6.83 3.06 11H1v2h2.06c.46 4.17 3.77 7.48 7.94 7.94V23h2v-2.06c4.17-.46 7.48-3.77 7.94-7.94H23v-2h-2.06zM12 19c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="960">
            <path d="M7 18h2V6H7v12zm4 4h2V2h-2v20zm-8-8h2v-4H3v4zm12 4h2V6h-2v12zm4-8v4h2v-4h-2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="984">
            <path fill-opacity=".3" d="M2 22h20V2z"/>
            <path d="M17 7L2 22h15z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1008">
            <path fill-opacity=".3"
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1032">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1056">
            <path d="M4 4h7V2H4c-1.1 0-2 .9-2 2v7h2V4zm6 9l-4 5h12l-3-4-2.03 2.71L10 13zm7-4.5c0-.83-.67-1.5-1.5-1.5S14 7.67 14 8.5s.67 1.5 1.5 1.5S17 9.33 17 8.5zM20 2h-7v2h7v7h2V4c0-1.1-.9-2-2-2zm0 18h-7v2h7c1.1 0 2-.9 2-2v-7h-2v7zM4 13H2v7c0 1.1.9 2 2 2h7v-2H4v-7z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1080">
            <path d="M13 13v8h8v-8h-8zM3 21h8v-8H3v8zM3 3v8h8V3H3zm13.66-1.31L11 7.34 16.66 13l5.66-5.66-5.66-5.65z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1104">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1128">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1152">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1248">
            <path fill-opacity=".3" d="M2 22h20V2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1272">
            <path fill-opacity=".3" d="M2 22h20V2z"/>
            <path d="M12 12L2 22h10z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1296">
            <path fill-opacity=".3" d="M2 22h20V2z"/>
            <path d="M14 10L2 22h12z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1320">
            <path fill-opacity=".3" d="M2 22h20V2z"/>
            <path d="M17 7L2 22h15z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1344">
            <path d="M2 22h20V2z"/>
        </svg>
    </span>
    <svg width="24" height="24" viewBox="0 0 24 24"
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1488">
            <path d="M18.99 5c0-1.1-.89-2-1.99-2h-7L7.66 5.34 19 16.68 18.99 5zM3.65 3.88L2.38 5.15 5 7.77V19c0 1.1.9 2 2 2h10.01c.35 0 .67-.1.96-.26l1.88 1.88 1.27-1.27L3.65 3.88z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1512">
            <path d="M20 6.83V20H6.83L20 6.83M22 2L2 22h20V2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1536">
            <path d="M21 1l-8.59 8.59L21 18.18V1zM4.77 4.5L3.5 5.77l6.36 6.36L1 21h17.73l2 2L22 21.73 4.77 4.5z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1560">
            <path fill-opacity=".3"
                  d="M12.01 21.49L23.64 7c-.45-.34-4.93-4-11.64-4C5.28 3 .81 6.66.36 7l11.63 14.49.01.01.01-.01z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1584">
            <path fill-opacity=".3"
                  d="M12.01 21.49L23.64 7c-.45-.34-4.93-4-11.64-4C5.28 3 .81 6.66.36 7l11.63 14.49.01.01.01-.01z"/>
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1608">
            <path fill-opacity=".3"
                  d="M12.01 21.49L23.64 7c-.45-.34-4.93-4-11.64-4C5.28 3 .81 6.66.36 7l11.63 14.49.01.01.01-.01z"/>
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1632">
            <path fill-opacity=".3"
                  d="M12.01 21.49L23.64 7c-.45-.34-4.93-4-11.64-4C5.28 3 .81 6.66.36 7l11.63 14.49.01.01.01-.01z"/>
            <path d="M3.53 10.95l8.46 10.54.01.01.01-.01 8.46-10.54C20.04 10.62 16.81 8 12 8c-4.81 0-8.04 2.62-8.47 2.95z"/>
        </svg>
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1656">
            <path d="M12.01 21.49L23.64 7c-.45-.34-4.93-4-11.64-4C5.28 3 .81 6.66.36 7l11.63 14.49.01.01.01-.01z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1680">
    ...
    <svg width="26" height="24" viewBox="0 0 26 24"
        ...
        <path fill-opacity=".3"
              d="M24.24 8l1.35-1.68C25.1 5.96 20.26 2 13 2S.9 5.96.42 6.32l12.57 15.66.01.02.01-.01L20 13.28V8h4.24z"/>
        <path d="M20 13.28V8.71C18.35 7.87 15.94 7 13 7c-5.44 0-9.07 2.97-9.44 3.24l9.43 11.75.01.01.01-.01L20 13.28zM22 22h2v-2h-2v2zm0-12v8h2v-8h-2z"/>
    </svg>
    <svg width="26" height="24" viewBox="0 0 26 24"
         y="1896">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="26" height="24" viewBox="0 0 26 24" y="1944">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1968">
            <path d="M2 20h20v-4H2v4zm2-3h2v2H4v-2zM2 4v4h20V4H2zm4 3H4V5h2v2zm-4 7h20v-4H2v4zm2-3h2v2H4v-2z"/>
        </svg>
    </span>
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="1992">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="2016">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" y="2040">
...
<fieldset>
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="240" y="144">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="168" y="240">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288" y="216">
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg width="24" height="24" viewBox="0 0 24 24" x="288" y="240">
...
<fieldset>
    ...
    <span onclick="copyToClipBord(this.innerHTML)">
        <svg viewBox="0 0 24 24" width="24" height="24" y="24">
